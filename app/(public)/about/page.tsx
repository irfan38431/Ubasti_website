          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <div className="flex flex-col gap-6">
                ...
                <p className="text-base leading-relaxed" style={{ color: "var(--ubasti-sage)" }}>
                  Ubasti started with a simple observation: Chennai has a million cat lovers,
                  but nowhere to be a cat lover together. We built the space we always wanted
                  to exist — named after Bastet, the Egyptian goddess of home and cats, who
                  understood that a purring cat is one of life&apos;s quiet joys.
                </p>
                <p className="text-base leading-relaxed" style={{ color: "var(--ubasti-sage)" }}>
            ...
            <ScrollReveal delay={0.1}>
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
                <Image
                  src="/images/placeholders/about-story.svg"
                  alt="The Ubasti lounge"
                  fill
            ...
            {[
              ...
              <ScrollReveal key={v.title}>
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm leading-relaxed" style={{ color: "var(--ubasti-cream)", opacity: 0.85 }}>
                    {v.body}
                  </p>
                </div>
              </ScrollReveal>
