  ...
  return (
    <div style={{ background: "var(--ubasti-paper)" }}>
      ...
      <section
        ...
        style={{ background: "var(--ubasti-blush)" }}
      >
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <SectionTitle
            eyebrow="Celebrate with Cats"
            title="Ready to Pawty?"
            subtitle="rent the lounge for your perfect celebration"
          />
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal delay={0.1}>
              <div className="flex flex-col gap-5">
                <p className="text-sm font-bold uppercase tracking-widest" style={{ color: "var(--ubasti-mustard)" }}>
                  Perfect For
                </p>
                ...
                <p className="text-lg leading-relaxed" style={{ color: "var(--ubasti-sage)" }}>
                  Birthdays · Anniversaries · Bachelorettes · Small corporate meetups ·
                  Or any moment worth remembering with cats.
                </p>
                <Link href="#inquiry"
      ...
      <section className="py-20 md:py-28" style={{ background: "var(--ubasti-cream)" }}>
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-16">
          <ScrollReveal>
            <SectionTitle eyebrow="Pricing" title="Choose Your Day" className="mb-12" />
          </ScrollReveal>
            ...
            {TIERS.map((tier, i) => (
              <ScrollReveal key={tier.label} delay={i * 0.1}>
                <div
                  ...
                  style={{
                    background: i === 1 ? "var(--ubasti-olive-dark)" : "var(--ubasti-white)",
                    color:      i === 1 ? "var(--ubasti-cream)"      : "var(--ubasti-ink)",
                ...
                >
                  ...
                  <a href="#inquiry"
                    ...
                    style={{
                      background: i === 1 ? "var(--ubasti-blush)"       : "var(--ubasti-olive-dark)",
                      color:      i === 1 ? "var(--ubasti-ink)"          : "var(--ubasti-cream)",
                    }}>
                    Book This
                  </a>
                </div>
          ...
          <p className="text-center text-sm mt-6 opacity-70" style={{ color: "var(--ubasti-sage)" }}>
            Want longer than 70 min or larger groups?{" "}
            <a href="#inquiry" className="underline">Send us an inquiry.</a>
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-6">
          <ScrollReveal>
            <SectionTitle eyebrow="Good to Know" title="House Rules" className="mb-10" />
          </ScrollReveal>
      ...
      <section className="py-16" style={{ background: "var(--ubasti-cream)" }}>
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-16">
          <p className="text-sm font-bold uppercase tracking-widest text-center mb-8" style={{ color: "var(--ubasti-mustard)" }}>
            The Lounge
          </p>
      ...
      <section className="py-24 md:py-32">
        <div className="max-w-2xl mx-auto px-6">
          <ScrollReveal>
            <SectionTitle eyebrow="Get in Touch" title="Send an Inquiry" className="mb-10" />
          </ScrollReveal>
          <InquiryForm />
        </div>
      </section>
      ...
      <section className="py-16 md:py-24" style={{ background: "var(--ubasti-cream)" }}>
        <div className="max-w-2xl mx-auto px-6">
          <ScrollReveal>
            <SectionTitle eyebrow="FAQ" title="Party Questions" className="mb-10" />
          </ScrollReveal>
              ...
              <details key={item.q} className="group py-5">
                <summary className="flex items-center justify-between cursor-pointer text-base font-medium list-none"
                  ...
                  <span className="text-xl transition-transform group-open:rotate-45 shrink-0 ml-4"
                    style={{ color: "var(--ubasti-mustard)" }}>+</span>
                </summary>
