            ...
            <div className="w-full">
              {done ? (
                <div className="rounded-2xl p-8 text-center" style={{ background: "var(--ubasti-white)" }}>
                  <p className="text-3xl" style={{ fontFamily: "var(--font-cormorant)", color: "var(--ubasti-olive-dark)", fontWeight: 600 }}>
                    Thank you!
                  </p>
                  <p className="text-sm mt-2" style={{ color: "var(--ubasti-sage)" }}>
